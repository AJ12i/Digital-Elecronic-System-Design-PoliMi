...
HD_PWD='C:/Users/alija/Audio/Audio.runs/BD_Moving_average_filter_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BD_Moving_average_filter_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BD_Moving_average_filter_0_0.tcl
