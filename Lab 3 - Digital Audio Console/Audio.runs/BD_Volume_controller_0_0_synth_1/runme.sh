...
HD_PWD='C:/Users/alija/Audio/Audio.runs/BD_Volume_controller_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BD_Volume_controller_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BD_Volume_controller_0_0.tcl
