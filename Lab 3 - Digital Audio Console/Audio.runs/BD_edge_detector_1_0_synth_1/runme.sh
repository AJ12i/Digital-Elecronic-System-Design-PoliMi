...
HD_PWD='C:/Users/alija/Audio/Audio.runs/BD_edge_detector_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BD_edge_detector_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BD_edge_detector_1_0.tcl
