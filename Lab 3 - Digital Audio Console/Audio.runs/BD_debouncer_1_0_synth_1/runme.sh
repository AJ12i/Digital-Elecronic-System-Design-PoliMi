...
HD_PWD='C:/Users/alija/Audio/Audio.runs/BD_debouncer_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BD_debouncer_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BD_debouncer_1_0.tcl
