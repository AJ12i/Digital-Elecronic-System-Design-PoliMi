...
# module references:
# Balance_controller, LED_controller, Moving_average_filter, Mute_controller, Toggle_reg, Toggle_reg, Volume_controller, debouncer, debouncer, digilent_jstk2, edge_detector, edge_detector
...
proc create_root_design { parentCell } {
  ...
  # Create instance: Toggle_reg_0, and set properties
  set block_name Toggle_reg
  set block_cell_name Toggle_reg_0
  if { [catch {set Toggle_reg_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $Toggle_reg_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: Toggle_reg_1, and set properties
  set block_name Toggle_reg
  set block_cell_name Toggle_reg_1
  if { [catch {set Toggle_reg_1 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $Toggle_reg_1 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  connect_bd_intf_net -intf_net Moving_average_filter_0_m_axis [get_bd_intf_pins Balance_controller_0/s_axis] [get_bd_intf_pins Moving_average_filter_0/m_axis]
  connect_bd_intf_net -intf_net Mute_controller_0_m_axis [get_bd_intf_pins Mute_controller_0/m_axis] [get_bd_intf_pins axis_dual_i2s_0/s_axis]
  ...
  connect_bd_intf_net -intf_net axis_dual_i2s_0_m_axis [get_bd_intf_pins Moving_average_filter_0/s_axis] [get_bd_intf_pins axis_dual_i2s_0/m_axis]
  ...
  connect_bd_net -net LED_controller_0_led_b [get_bd_pins LED_controller_0/led_b] [get_bd_pins digilent_jstk2_0/led_b]
  connect_bd_net -net LED_controller_0_led_g [get_bd_pins LED_controller_0/led_g] [get_bd_pins digilent_jstk2_0/led_g]
  connect_bd_net -net LED_controller_0_led_r [get_bd_pins LED_controller_0/led_r] [get_bd_pins digilent_jstk2_0/led_r]
  connect_bd_net -net Net [get_bd_pins Toggle_reg_0/rst] [get_bd_pins Toggle_reg_1/rst] [get_bd_pins debouncer_0/reset] [get_bd_pins debouncer_1/reset] [get_bd_pins edge_detector_0/reset] [get_bd_pins edge_detector_1/reset] [get_bd_pins proc_sys_reset_0/peripheral_reset]
  connect_bd_net -net Toggle_reg_0_output_signal [get_bd_pins LED_controller_0/mute_enable] [get_bd_pins Mute_controller_0/mute_enable] [get_bd_pins Toggle_reg_0/output_signal]
  connect_bd_net -net Toggle_reg_1_output_signal [get_bd_pins LED_controller_0/filter_enable] [get_bd_pins Moving_average_filter_0/filter_enable] [get_bd_pins Toggle_reg_1/output_signal]
  ...
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins Balance_controller_0/aclk] [get_bd_pins Moving_average_filter_0/aclk] [get_bd_pins Mute_controller_0/aclk] [get_bd_pins Toggle_reg_0/clk] [get_bd_pins Toggle_reg_1/clk] [get_bd_pins Volume_controller_0/aclk] [get_bd_pins axi4stream_spi_master_0/aclk] [get_bd_pins axis_dual_i2s_0/aclk] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins debouncer_0/clk] [get_bd_pins debouncer_1/clk] [get_bd_pins digilent_jstk2_0/aclk] [get_bd_pins edge_detector_0/clk] [get_bd_pins edge_detector_1/clk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk]
  ...
  connect_bd_net -net digilent_jstk2_0_jstk_y [get_bd_pins Volume_controller_0/volume] [get_bd_pins digilent_jstk2_0/jstk_y]
  connect_bd_net -net edge_detector_0_edge_detected [get_bd_pins Toggle_reg_0/input_signal] [get_bd_pins edge_detector_0/edge_detected]
  connect_bd_net -net edge_detector_1_edge_detected [get_bd_pins Toggle_reg_1/input_signal] [get_bd_pins edge_detector_1/edge_detected]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins Balance_controller_0/aresetn] [get_bd_pins Moving_average_filter_0/aresetn] [get_bd_pins Mute_controller_0/aresetn] [get_bd_pins Volume_controller_0/aresetn] [get_bd_pins axi4stream_spi_master_0/aresetn] [get_bd_pins axis_dual_i2s_0/aresetn] [get_bd_pins digilent_jstk2_0/aresetn] [get_bd_pins proc_sys_reset_0/peripheral_aresetn]
