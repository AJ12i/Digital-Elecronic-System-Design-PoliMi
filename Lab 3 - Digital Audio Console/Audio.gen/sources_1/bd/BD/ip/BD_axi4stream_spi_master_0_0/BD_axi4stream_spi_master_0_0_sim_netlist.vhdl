...
-- Date        : Thu May 18 16:35:43 2023
-- Host        : DESKTOP-AVPI1T7 running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim -rename_top BD_axi4stream_spi_master_0_0 -prefix
--               BD_axi4stream_spi_master_0_0_ BD_axi4stream_spi_master_0_0_sim_netlist.vhdl
-- Design      : BD_axi4stream_spi_master_0_0
...
entity BD_axi4stream_spi_master_0_0_lw_spi_master is
  port (
    cs_o : out STD_LOGIC;
...
end BD_axi4stream_spi_master_0_0_lw_spi_master;

architecture STRUCTURE of BD_axi4stream_spi_master_0_0_lw_spi_master is
  ...
  signal edgecntr : STD_LOGIC_VECTOR ( 14 downto 0 );
  ...
  signal \edgecntr0_carry__2_n_3\ : STD_LOGIC;
  ...
  signal \edgecntr[14]_i_1_n_0\ : STD_LOGIC;
  signal \edgecntr[14]_i_3_n_0\ : STD_LOGIC;
  signal \edgecntr[14]_i_4_n_0\ : STD_LOGIC;
  signal \edgecntr[14]_i_5_n_0\ : STD_LOGIC;
  signal \edgecntr[14]_i_6_n_0\ : STD_LOGIC;
  signal edgecntr_0 : STD_LOGIC_VECTOR ( 14 downto 0 );
  ...
  signal \NLW_edgecntr0_carry__2_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 1 );
  signal \NLW_edgecntr0_carry__2_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 2 );
  ...
  attribute SOFT_HLUTNM of \edgecntr[13]_i_1\ : label is "soft_lutpair16";
...
\edgecntr0_carry__2\: unisim.vcomponents.CARRY4
     port map (
      ...
      CO(3 downto 1) => \NLW_edgecntr0_carry__2_CO_UNCONNECTED\(3 downto 1),
      CO(0) => \edgecntr0_carry__2_n_3\,
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3 downto 2) => \NLW_edgecntr0_carry__2_O_UNCONNECTED\(3 downto 2),
      O(1 downto 0) => data0(14 downto 13),
      S(3 downto 2) => B"00",
      S(1 downto 0) => edgecntr(14 downto 13)
    );
...
\edgecntr[13]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
\edgecntr[14]_i_1\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
      I0 => sclk_en,
      O => \edgecntr[14]_i_1_n_0\
    );
\edgecntr[14]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
\edgecntr[14]_i_3\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFFFFEFFFFF"
    )
        port map (
      I0 => \edgecntr[14]_i_4_n_0\,
      I1 => \edgecntr[14]_i_5_n_0\,
      I2 => edgecntr(14),
      I3 => edgecntr(13),
      I4 => edgecntr(0),
      I5 => \edgecntr[14]_i_6_n_0\,
      O => \edgecntr[14]_i_3_n_0\
    );
\edgecntr[14]_i_4\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
      ...
      I2 => edgecntr(8),
      I3 => edgecntr(7),
      O => \edgecntr[14]_i_4_n_0\
    );
\edgecntr[14]_i_5\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"7FFF"
    )
        port map (
      ...
      I2 => edgecntr(4),
      I3 => edgecntr(3),
      O => \edgecntr[14]_i_5_n_0\
    );
\edgecntr[14]_i_6\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FF7F"
    )
        port map (
...
\edgecntr_reg[14]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity BD_axi4stream_spi_master_0_0_axis_lw_spi_master is
  port (
    m_axis_tdata : out STD_LOGIC_VECTOR ( 7 downto 0 );
    sclk_o : out STD_LOGIC;
    cs_o : out STD_LOGIC;
...
end BD_axi4stream_spi_master_0_0_axis_lw_spi_master;

architecture STRUCTURE of BD_axi4stream_spi_master_0_0_axis_lw_spi_master is
...
inst_lw_spi_master: entity work.BD_axi4stream_spi_master_0_0_lw_spi_master
     port map (
      aclk => aclk,
      aresetn => aresetn,
      cs_o => cs_o,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity BD_axi4stream_spi_master_0_0_ipi_axis_lw_spi_master is
  port (
    m_axis_tdata : out STD_LOGIC_VECTOR ( 7 downto 0 );
    sclk_o : out STD_LOGIC;
    cs_o : out STD_LOGIC;
...
end BD_axi4stream_spi_master_0_0_ipi_axis_lw_spi_master;

architecture STRUCTURE of BD_axi4stream_spi_master_0_0_ipi_axis_lw_spi_master is
begin
inst_axis_lw_spi_master: entity work.BD_axi4stream_spi_master_0_0_axis_lw_spi_master
     port map (
      aclk => aclk,
      aresetn => aresetn,
      cs_o => cs_o,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity BD_axi4stream_spi_master_0_0 is
  port (
    aclk : in STD_LOGIC;
    aresetn : in STD_LOGIC;
    s_axis_tvalid : in STD_LOGIC;
  ...
  attribute NotValidForBitStream of BD_axi4stream_spi_master_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of BD_axi4stream_spi_master_0_0 : entity is "BD_axi4stream_spi_master_0_0,ipi_axis_lw_spi_master,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of BD_axi4stream_spi_master_0_0 : entity is "yes";
  attribute ip_definition_source : string;
  attribute ip_definition_source of BD_axi4stream_spi_master_0_0 : entity is "package_project";
  attribute x_core_info : string;
  attribute x_core_info of BD_axi4stream_spi_master_0_0 : entity is "ipi_axis_lw_spi_master,Vivado 2020.2";
end BD_axi4stream_spi_master_0_0;

architecture STRUCTURE of BD_axi4stream_spi_master_0_0 is
  ...
  attribute x_interface_parameter of aclk : signal is "XIL_INTERFACENAME aclk, ASSOCIATED_BUSIF S_AXIS:M_AXIS, FREQ_HZ 200000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN /clk_wiz_0_clk_out1, INSERT_VIP 0";
  ...
  attribute x_interface_parameter of m_axis_tvalid : signal is "XIL_INTERFACENAME M_AXIS, TDATA_NUM_BYTES 1, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 0, HAS_TREADY 0, HAS_TSTRB 0, HAS_TKEEP 0, HAS_TLAST 0, FREQ_HZ 200000000, PHASE 0.0, CLK_DOMAIN /clk_wiz_0_clk_out1, LAYERED_METADATA undef, INSERT_VIP 0";
...
U0: entity work.BD_axi4stream_spi_master_0_0_ipi_axis_lw_spi_master
     port map (
      aclk => aclk,
      aresetn => aresetn,
      cs_o => cs_o,
