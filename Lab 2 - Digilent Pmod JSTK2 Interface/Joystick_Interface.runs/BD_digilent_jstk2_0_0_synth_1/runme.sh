...
HD_PWD='C:/Users/alija/Joystick_Interface/Joystick_Interface.runs/BD_digilent_jstk2_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BD_digilent_jstk2_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BD_digilent_jstk2_0_0.tcl
